  ...
  return (
    <main className="min-h-screen w-full">
      ...
      >
        ...
        <div className={`absolute inset-x-0 lg:inset-x-auto top-18 lg:top-32 lg:left-24 lg:text-left text-center text-white drop-shadow-l max-w-xl pointer-events-none z-0 mx-auto lg:mx-0`} >
        ...
        <motion.div
          ...
          className={`absolute top-0 lg:top-[19%] left-1/2 -translate-x-1/2 isolate flex flex-col items-center justify-center ${!isMobile ? "ml-85" : ""} w-full max-w-[672px] px-4 ${(isMobile && hasMessages) ? "py-4" : ""}`}
